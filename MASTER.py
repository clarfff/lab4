...
userInput = input("Please enter either: msk or psk: ")
print(str(userInput))
...
if userInput == "msk":
    ...
    userInputTwo = input("Please enter sample per symbol rate as single value: ")
    userInputThree = input("Please enter sample rate: ")
    ...
    class base_msk(gr.top_block, Qt.QWidget):

        def __init__(self):
            gr.top_block.__init__(self, "base_msk", catch_exceptions=True)
            Qt.QWidget.__init__(self)
            self.setWindowTitle("base_msk")
            ...
            self.settings = Qt.QSettings("GNU Radio", "base_msk")
            ...
            # Variables
            ##################################################
            self.samp_rate = samp_rate = int(userInputThree)
            ...
            self.digital_gmsk_mod_0 = digital.gmsk_mod(
                samples_per_symbol= userInputTwo,
                bt=0.3,
                verbose=False,
                log=False,
                do_unpack=True)
    ...
    def main(top_block_cls=base_msk, options=None):
    ...
    userInputFour = input("Please enter sample per symbol rate as a single value: ")
    userInputFive = input("Please enter sample rate: ")
    ...
    class psk_test(gr.top_block, Qt.QWidget):
        ...
        def __init__(self):
            ...
            # Variables
            ##################################################
            self.samp_rate = samp_rate = int(userInputFive)
            ...
            self.digital_psk_mod_0 = digital.psk.psk_mod(
                ...
                mod_code="gray",
                differential=True,
                samples_per_symbol= int(userInputFour),
                excess_bw=0.30,
                verbose=False,
                log=False)
            self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
